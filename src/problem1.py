...
def test_problem1a():
    ...
    # ------------------------------------------------------------------
    expected = 0.866  # This is APPROXIMATELY the correct answer.
    answer = problem1a(50, 80)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    expected = -0.605  # This is APPROXIMATELY the correct answer.
    answer = problem1a(42, 90)
    print()
...
def test_problem1b():
    ...
    print('       actual:  ', answer)
    expected = 27  # This is APPROXIMATELY the correct answer.
    answer = problem1b(6, 20)
    print()
